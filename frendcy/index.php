...
<html <?php if($user){ ?>class="logged"<?php } ?>>
    <head>
        ...
        <meta property="og:image" content="http://www.frendcy.com/images/thumbnail.png"/>
        <title>Frendcy</title>
        <!--[if lte IE 9]>
            <script>
        ...
        <meta name="description" content="Are you a secret admirer? Do you know who's interested in you? Join frendcy via Facebook today and start finding out who's in your friend list has secret feeling for you!">
        <meta name="keywords" content="Show interest, express your interest, express love, I love you, I fancy you, fancy, I admire you, who admire me, admire, secret">
    ...
    <body>
        ...
        <header>
            <nav>
                ...
                <h1>Are you a secret admirer?<br />A quiet way to find who likes you</h1>
                <a class="fb-login" href="<?php echo $loginUrl; ?>"><span class="worried">We don't post anything on your wall</span></a>
            </nav>
        </header>
        <div class="container">
            <?php if ($user): ?>
